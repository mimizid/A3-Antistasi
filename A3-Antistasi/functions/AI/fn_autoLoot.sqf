...
if (_unit getVariable ["helping",false]) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_noRearm"};
_rearming = _unit getVariable "rearming";
if (_rearming) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_cancel"; _unit setVariable ["rearming",false]};
if (_unit == gunner _truckX) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_noRearm_gun"};
if (!canMove _truckX) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_noRearm_repair"};
...
if (count _objectsX == 0) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_noCorpses"};
...
if (isNull _target) exitWith {_unit groupChat localize "STR_antistasi_chat_loot_nothing"};
_target setVariable ["busy",true];
_unit setVariable ["rearming",true];
_unit groupChat localize "STR_antistasi_chat_loot_start";
...
if (!_continuar) then
	{
	_unit groupChat localize "STR_antistasi_chat_loot_noWeap"
	};
