...
if (!([player] call A3A_fnc_hasRadio)) exitWith {if !(hasIFA) then {[localize "STR_antistasi_customHint_recruit_squad", localize "STR_antistasi_customHint_minefields_noradio"] call A3A_fnc_customHint;} else {[localize "STR_antistasi_customHint_recruit_squad", localize "STR_antistasi_customHint_minefields_no_radioman"] call A3A_fnc_customHint;}};
...
if (_typeGroup isEqualType "") then {
	...
	if (hasIFA and ((_typeGroup == SDKMortar) or (_typeGroup == SDKMGStatic)) and !debug) then {_exit = true; [localize "STR_antistasi_customHint_recruit_squad", localize "STR_antistasi_customHint_recruit_modset"] call A3A_fnc_customHint;};
};
...
if ((_withBackpck != "") and hasIFA) exitWith {[localize "STR_antistasi_customHint_recruit_squad", localize "STR_antistasi_customHint_recruit_modset_static"] call A3A_fnc_customHint;};
