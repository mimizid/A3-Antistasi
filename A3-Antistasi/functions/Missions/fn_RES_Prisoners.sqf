...
[[teamPlayer,civilian],"RES",[format [localize "STR_antistasi_mission_rescue_text",_nameDest,_displayTime],localize "STR_antistasi_mission_rescue",_markerX],_positionX,false,0,true,"run",true] call BIS_fnc_taskCreate;
...
if ({alive _x} count _POWs == 0) then
	{
	["RES",[format [localize "STR_antistasi_mission_rescue_text",_nameDest,_displayTime],localize "STR_antistasi_mission_rescue",_markerX],_positionX,"FAILED","run"] call A3A_fnc_taskUpdate;
	...
	{
	sleep 5;
	["RES",[format [localize "STR_antistasi_mission_rescue_text",_nameDest,_displayTime],localize "STR_antistasi_mission_rescue",_markerX],_positionX,"SUCCEEDED","run"] call A3A_fnc_taskUpdate;
