...
if ((({not (captive _x)} count _soldiers) < ({captive _x} count _soldiers)) or ({alive _x} count _soldiers < round (_soldiersSpawned / 3)) or (time > _missionExpireTime)) then {
	...
	["invaderPunish",[format [localize "STR_antistasi_mission_invader_text",_nameDestination,nameInvaders],format ["localize STR_antistasi_mission_invader_name",nameInvaders],_attackDestination],getMarkerPos _attackDestination,"SUCCEEDED"] call A3A_fnc_taskUpdate;
	...
	["invaderPunish",[format [localize "STR_antistasi_mission_invader_text",_nameDestination,nameInvaders],format [localize "STR_antistasi_mission_invader_name",nameInvaders],_attackDestination],getMarkerPos _attackDestination,"FAILED"] call A3A_fnc_taskUpdate;
