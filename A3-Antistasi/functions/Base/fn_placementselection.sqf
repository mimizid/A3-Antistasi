...
if (_newGame) then {
	...
	"STR_antistasi_customHint_startPosition" hintC [localize "STR_antistasi_customHint_startPosition1", localize "STR_antistasi_customHint_startPosition2", localize "STR_antistasi_customHint_startPosition3", localize "STR_antistasi_customHint_startPosition4"];
} else {
