...
if (activeGREF and ((typeOf _staticX == staticATteamPlayer) or (typeOf _staticX == staticAAteamPlayer))) exitWith {[localize "STR_antistasi_customHint_steal", localize "STR_antistasi_customHint_steal_noDissassembled"] call A3A_fnc_customHint;};
