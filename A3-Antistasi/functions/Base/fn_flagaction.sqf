...
switch _typeX do
{
    ...
    case "steal":
    {
        _flag addAction [localize"STR_antistasi_addAction_stealStatic", A3A_fnc_stealStatic,nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])",4]
    };
    case "garage":
    {
